...
audio framework (for example, fig. \ref{fig:ryukau}); and many more examples, like all the web synthesizers available 
...
its interface strongly resembles a conventional desktop-based DAW, also requiring a desktop browser.

That is why, through this project, the author argues the need for a stripped-down DAW---consisting of 
just a sequencer/synthesizer/sampler; hence the name picoDAW---that is accessible (i) because it is 
built for the web, and (ii) has a simplified user interface, approachable not because it is the 
conventional interface that every other DAW uses, but because it is approachable.
