...
\begin{figure}[!htbp]
  ...
  fidelity exports of the same songs available as free lower fidelity previews}
...
framework (Fig. \ref{fig:ryukau}); and many more examples, like all the web synthesizers available 
