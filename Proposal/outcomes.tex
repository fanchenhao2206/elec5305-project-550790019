...
oscillator. (iii) Volume control in mixer for each instrument, and basic effects---reverb, delay, and EQ---with routing done through the mixer. See fig. \ref{fig:draft} for a draft of how the UI could work.
