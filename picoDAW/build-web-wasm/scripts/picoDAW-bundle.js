/**
 * picoDAW - iPlug2 Wasm Web Component Bundle
 *
...
window.Module = window.Module || {
  preRun: [],
  postRun: [],
  print: text => console.log('[picoDAW]', text),
  printErr: text => console.error('[picoDAW] stderr:', text)
};

(function() {
  'use strict';

  const PLUGIN_NAME = 'picoDAW';
  const PLUGIN_NAME_LC = 'picodaw';
  const PLUGIN_TAG = 'iplug-picodaw';
  const NUM_INPUTS = 0;
  const NUM_OUTPUTS = 2;
